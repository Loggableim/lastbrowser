...
for /d /r "C:\Users\<user>\hermes-webui\api" %%d in (__pycache__) do (
    if exist "%%d" rmdir /s /q "%%d" 2>nul
)
if exist "C:\Users\<user>\hermes-webui\__pycache__" (
    rmdir /s /q "C:\Users\<user>\hermes-webui\__pycache__" 2>nul
)
...
:: ── Server starten ──
"%PYTHON%" "C:\Users\<user>\hermes-webui\server.py"
