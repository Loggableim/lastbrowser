...
def check_for_updates(force=False):
    ...
    try:
        ...
        # If any repo check fails (git fetch timeout, subprocess error, etc.),
        # return the cached result with an error flag rather than crashing
        # with a 500. This is a non-critical feature: a failed update check
        # should not make the /api/updates/check endpoint return 500.
        with _cache_lock:
